    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CLIENT', 'Cliente'), ('ADMIN', 'Administrador'), ('SUPERADMIN', 'Superadministrador')], default='CLIENT', max_length=15)),
                ('phone_number', models.CharField(blank=True, max_length=20)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('membership_tier', models.CharField(choices=[('STANDARD', 'Standard'), ('ELITE', 'Elite'), ('ULTRA', 'Ultra'), ('CORPORATE', 'Corporate')], default='STANDARD', max_length=20)),
                ...
                ('preferred_aircraft_type', models.CharField(blank=True, max_length=100)),
                ('preferred_seat_type', models.CharField(blank=True, max_length=50)),
                ('preferred_meal_type', models.CharField(blank=True, max_length=50)),
